...
interface SpecialForm {[name: string]: Function}
 
var specialForms: SpecialForm = {};

specialForms["if"] = function(args: Array<any>, env: Environment) {
  if (args.length != 3)
...
specialForms["while"] = function(args: Array<any>, env: Environment) {
  if (args.length != 2)
...
specialForms["do"] = function(args: Array<any>, env: Environment) {
  var value = false;
...
specialForms["define"] = function(args: Array<any>, env: Environment) {
