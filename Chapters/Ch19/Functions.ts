...
module Functions {
	...
	export function randomPointInRadius(radius: number): Objects.Vector {
		for (; ;) {
	...
	export function relativePos(event: MouseEvent, element: HTMLCanvasElement): Objects.Vector {
		var rect = element.getBoundingClientRect();
		return new Objects.Vector(
