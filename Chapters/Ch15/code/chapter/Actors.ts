...
interface IActor { pos: Vector, size: Vector, speed?: Vector, type: string, act?: Function }
...
class Player implements IActor {
	...
	act = function(step: number, level: Level, keys:IKeysPressed) {
